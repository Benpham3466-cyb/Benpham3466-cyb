...
- [Microsoft Sentinel Tag-Change Investigation](https://github.com/Benpham3466-cyb/Cybersecurity-Portfolio/blob/main/projects/sentinel-tag-change-investigation.md) — guided KQL investigation, alert correlation, and benign incident disposition.
